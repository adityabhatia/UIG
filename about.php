...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid innerContainer" width=200px>
			...
			<p style="float:left;">	The Chair of Information Systems IV of the University of Mannheim in Germany focuses in research & education on Enterprise Systems.
			 	Thereby Information Systems are seen being a fundamentally socio-technical matter.
			 	Central part is to investigate the life cycle covering a development, implementation and use phase as well as novel concepts of Enterprise Systems.
			</p><br/>
			...
			<p style="float:left;">	InES was founded as the Institute of Enterprise Systems of the University of Mannheim. 
